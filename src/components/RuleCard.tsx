  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 mb-8 border border-white/20 shadow-xl text-white">
      <div className="flex items-center justify-between gap-4">
        <div className="flex flex-col items-center flex-1 p-3 bg-rose-500/20 rounded-xl border border-rose-500/30">
        ...
        <div className="flex flex-col items-center flex-1 p-3 bg-emerald-500/20 rounded-xl border border-emerald-500/30">
